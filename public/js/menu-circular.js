...
$(document).ready(function(){
     ...
     var divTop = ($("#divCircle").height() - $("#gts-logo").height())/2;
     var divLeft = ($("#divCircle").width() - $("#gts-logo").width())/2;
     $("#gts-logo").css("top",divTop + "px");
     $("#gts-logo").css("left",divLeft + "px");
})

$(document).ready(function(){
     //Arrange the icons in a circle centered in the div
     numItems = $( '.ejemplo' ).length; //How many items are in the circle?
